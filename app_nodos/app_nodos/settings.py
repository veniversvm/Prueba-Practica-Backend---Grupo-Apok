...
INSTALLED_APPS = [
    ...
    'drf_spectacular',
    'nodes', # Nuestra nueva app
    'users', # App para gestión de usuarios y autenticación personalizada
]
...
DATABASES = {
    "default": {
        "ENGINE": "django.db.backends.postgresql", # Django 5 usará psycopg 3 automáticamente
